  ...
  return (
    <div className="modal-backdrop">
      <div className="modal wide-modal">
        ...
        <form className="stack" onSubmit={(e) => { e.preventDefault(); onConfirm({ name, url }); }}>
          ...
          <div className="toolbar">
            <button type="submit" className="btn primary" disabled={busy}>{busy ? "Importing..." : "Create MOC"}</button>
