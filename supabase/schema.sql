...
create policy parts_insert_own on public.moc_parts
...
create policy parts_update_own on public.moc_parts
...
create policy parts_delete_own on public.moc_parts
